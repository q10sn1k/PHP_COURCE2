...
Вложенные запросы позволяют использовать результат одного запроса в качестве входных данных для другого запроса
...
INNER JOIN - это тип объединения, который выбирает только те строки, которые имеют соответствующие значения в обеих таблицах.

INNER JOIN соединяет строки из левой таблицы с теми, которые имеют соответствующие значения в таблице справа.
...
Здесь table1 и table2 - имена таблиц, а column - название столбцов, которые используются для объединения 2-х таблиц.
...
Если в правой таблице нет соответствующих строк, то в результате будут возвращены значения NULL
